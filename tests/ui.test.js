...
const src = fs.readFileSync(dir + '/js/carrera.js', 'utf8') + '\n'
  + fs.readFileSync(dir + '/js/losestudiantes.js', 'utf8') + '\n'
...
if (selHor) {
  ...
  chk(Object.values(w.__api.S.horario.grupos)[0] === selHor.value, 'el grupo elegido se guarda');
}
